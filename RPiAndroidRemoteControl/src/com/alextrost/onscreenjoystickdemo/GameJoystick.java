...
public class GameJoystick {
	...
	public GameJoystick(Resources res){
		...
		_joystick = (Bitmap)BitmapFactory.decodeResource(res, com.alextrost.onscreenjoystickdemo.R.drawable.joystick);
		_joystickBg = (Bitmap)BitmapFactory.decodeResource(res, com.alextrost.onscreenjoystickdemo.R.drawable.joystick_bg);
